...
```
yarn add eslint-config-react@git+ssh://git@github.com:carebithealth/eslint-config-react.git#[git-commit-hash]
```

This should create a line in `package.json` that looks like this:

```
"eslint-config-react": "git+ssh://git@github.com:carebithealth/eslint-config-react.git#0581cdb3fc1a18d0a2866e1c7978f58f547a7e27",
...
- clients/patients/package.json
- clients/control-center/package.json
- clients/carebit-shared/package.json

---

# Original eslint-config-react-app documentation below
